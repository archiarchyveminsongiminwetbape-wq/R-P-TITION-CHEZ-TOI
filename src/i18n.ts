...
const resources = {
  fr: { translation: {
    ...
    teacher: {
      ...
      reviews_title: 'Avis des parents',
      reviews_none: 'Aucun avis pour le moment.',
      reviews_average: 'Note moyenne',
      reviews_form_title: 'Donner mon avis',
      reviews_rating_label: 'Note (1 à 5)',
      reviews_comment_label: 'Commentaire (optionnel)',
      reviews_submit: 'Envoyer mon avis',
    },
    messages: {
      title: 'Messagerie',
      loading: 'Chargement…',
  ...
  en: { translation: {
    ...
    teacher: {
      ...
      reviews_none: 'No review yet.',
      reviews_average: 'Average rating',
      reviews_form_title: 'Leave a review',
      reviews_rating_label: 'Rating (1 to 5)',
      reviews_comment_label: 'Comment (optional)',
